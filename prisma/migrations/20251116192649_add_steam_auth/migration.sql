/*
  ...
  - You are about to drop the column `author` on the `Build` table. All the data in the column will be lost.
  - You are about to drop the column `author` on the `Comment` table. All the data in the column will be lost.
  - You are about to drop the column `author` on the `Guide` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Build" DROP COLUMN "author",
...
-- AlterTable
ALTER TABLE "Guide" DROP COLUMN "author",
ADD COLUMN     "authorId" TEXT NOT NULL;
